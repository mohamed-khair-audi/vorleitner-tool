...
<div class="form-section">
    ...
    <div class="form-row">
        <div class="form-field form-field--narrow">
            ...
            <input type="text" id="kunde_plz" name="kunde_plz" pattern="[0-9]{5}" inputmode="numeric" maxlength="5" data-error-message="PLZ muss genau 5 Ziffern enthalten">
        </div>
        <div class="form-field form-field--grow">
            <label for="kunde_ort">Ort</label>
            <input type="text" id="kunde_ort" name="kunde_ort">
        </div>
    </div>
    <div class="form-row">
        <div class="form-field">
        ...
        <div class="form-field">
            ...
            <input type="email" id="kunde_email" name="kunde_email" autocomplete="email" placeholder="Für Auftragsbestätigung (optional)">
        </div>
    </div>
</div>
